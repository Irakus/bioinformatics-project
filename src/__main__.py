...
#    Jan 18, 2020 07:25:26 PM CET  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.SelectProgram.configure(textvariable=GUI_support.combobox1)
        ...
        self.AlgorithmCombo.place(relx=0.118, rely=0.801, relheight=0.03
                , relwidth=0.154)
        self.AlgorithmCombo.configure(textvariable=GUI_support.combobox2)
        ...
        self.ConsensusMode.place(relx=0.032, rely=0.186, relheight=0.03
                , relwidth=0.154)
        self.ConsensusMode.configure(exportselection="0")
        self.ConsensusMode.configure(textvariable=GUI_support.combobox3)
